...
public class ModifierContainer
{
    ...
    private static Dictionary<ModifierTarget, ModifierCombinationMode> combinationModes = new Dictionary<ModifierTarget, ModifierCombinationMode>()
    {
        ...
        { ModifierTarget.HealthRegen,       ModifierCombinationMode.Add },
        { ModifierTarget.Energy,            ModifierCombinationMode.Add },
        { ModifierTarget.EnergyRegen,       ModifierCombinationMode.Add },
    };
